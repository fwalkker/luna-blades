...
const ROWS: Row[] = [
  {
    badge: "01 · Durability",
    titlePre: "Built to survive real use — ",
    titleAccent: "not just display",
    body: "Every Luna saber is built to be dropped, swung hard, and generally put through it — not just set on a shelf. We test each model under heavy strikes, drops, and even car tires before it ships, so it won't crack like a cheap toy saber.",
  ...
  {
    badge: "02 · Comfort",
    titlePre: "Comfortable and balanced ",
    titleAccent: "in the hand",
    body: "The handle is weighted to feel solid and balanced, with a grip that stays steady through swings and spins.",
    highlight: "It feels like the real thing, not a flimsy prop.",
  ...
  {
    badge: "03 · Fun",
    titlePre: "More than a saber — ",
    titleAccent: "it's hours of fun",
    body: "There's a reason people don't put these down. Light it up and it pulls everyone in: backyard duels with friends and siblings, late-night battles in the hallway, showing it off to anyone who walks in the door.",
    highlight: "It's the kind of thing that turns an ordinary afternoon into an event — and it stays just as fun years later.",
